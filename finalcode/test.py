...
def main():
    ...
    if imu_port2:
        imu_2 = WitMotion(imu_port=imu_port2, baud_rate=115200,
                          save_data=True, save_path=currentTime)
        imu_2.start()

    if imu_port1:
        imu_1 = WitMotion(imu_port=imu_port1, baud_rate=115200,
                          save_data=True, save_path=currentTime)
        imu_1.start()
