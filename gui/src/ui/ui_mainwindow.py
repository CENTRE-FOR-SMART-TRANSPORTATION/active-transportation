...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(
            self.tabWindow.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate(
            "MainWindow", u"Starrtracker", None))
        ...
        self.actionPandarView_Path.setText(
            QCoreApplication.translate("MainWindow", u"PandarView Path", None))
        self.actionRecording_Path.setText(
            QCoreApplication.translate("MainWindow", u"Recording Path", None))
        self.actionSet_Password.setText(
            QCoreApplication.translate("MainWindow", u"Set Password", None))
        self.addSensor.setText(QCoreApplication.translate(
            "MainWindow", u"Add Sensor", None))
